...
public class DataStorage {
	...
	{
		fis = new FileInputStream("./src/test/resources/DataContainer/data.properties");
		pobj.load(fis);
														...
														throws Exception, IOException
	{
		...
		FileOutputStream fos = new FileOutputStream("./DataContainer/TestData.xlsx");
		book.write(fos);
		fos.flush();
	}
														...
														throws Exception, IOException
	{
		...
		cel.setCellValue(newData);
		FileOutputStream fos = new FileOutputStream("./src/test/resources/DataContainer/TestData.xlsx");
		book.write(fos);
		fos.flush();
	}
}
